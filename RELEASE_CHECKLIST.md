...
- [x] Banner adaptativo encima de la navegación inferior para usuarios Free.
- [x] Usuarios Premium no instancian el banner.
- [x] Debug usa IDs de prueba oficiales de Google.
...
- [ ] Completar configuración de Privacidad/Mensajería de AdMob.
